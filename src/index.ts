...
import { AudioConfig, CompactionConfig, EmbeddingConfig, FailoverConfig, ImageGenerationConfig, ModelConfig, ProviderConfig, VisionConfig } from './narrator'
...
export const inject = { required: ['database', 'http'], optional: ['puppeteer', 'console', 'server'] }
