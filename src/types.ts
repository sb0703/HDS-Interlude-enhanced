...
export interface SchedulePreplanWindow {
  ...
  recentBlocks?: Array<SchedulePreplanBlock & { date: string }>
}
...
export interface NarrativeDecision {
  ...
  interaction?: NarrativeInteraction
  /** One paid image attached to an eligible immediate message. */
...
export interface NarrativeRequest {
  ...
  timelineFallback?: { mode: 'conservative'; failureCount: number }
