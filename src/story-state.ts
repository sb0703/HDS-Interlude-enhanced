import { normalizeTimelineBoundary } from './timeline-boundary'
...
const KNOWN_STORY_STATE_KEYS = new Set([
  'schemaVersion', 'extensions', 'timelineBoundary', 'scheduleProfileFingerprint', 'settingOverlay', 'activeSceneId', 'activeArcId',
...
export function upgradeStoryState(value: unknown): StoryState {
  ...
  return {
    ...
    timelineBoundary: normalizeTimelineBoundary(record.timelineBoundary ?? existingExtensions.timelineBoundary),
    scheduleProfileFingerprint: textOrUndefined(record.scheduleProfileFingerprint ?? existingExtensions.scheduleProfileFingerprint),
    ...
    automation: {
      ...
      timelineDirectorRefused: automation.timelineDirectorRefused === true || undefined,
