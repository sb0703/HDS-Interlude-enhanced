...
export declare function schedulePreplanWindow(record: SchedulePreplanRecord | undefined, now: Date, timezone: string, hours?: number, config?: Pick<SchedulePreplanConfig, 'candidateActivationProbability' | 'candidateRevealMinutes'>, from?: Date): SchedulePreplanWindow | null;
