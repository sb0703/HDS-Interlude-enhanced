...
test('the visible reply remains an event inside one causal script', () => {
  ...
  assert.match(prompt, /write its exact words naturally in the living script/)
  assert.match(prompt, /copy the same complete words into the matching transport content field/)
